...
public class GATTConnection extends Service {
    ...
    if (bluetoothAdapter == null || deviceAddress == null) {
        ...
        if (mBluetoothDeviceAddress != null && deviceAddress.equals(mBluetoothDeviceAddress)
                && bluetoothGatt != null) {
